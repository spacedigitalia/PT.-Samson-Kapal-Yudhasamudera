            ...
            <form action="/dashboard/company-kpis/process.php" method="POST" class="space-y-6" id="kpiForm">
                ...
                <div class="border-t border-slate-200 pt-6">
                    <div class="flex items-center justify-between mb-3">
                        <label class="block text-sm font-semibold text-slate-700">List (value, title, description)</label>
                    ...
                    <div id="listItemsWrap" class="space-y-3">
                        ...
                        <div class="list-item-row flex flex-wrap gap-4 items-start p-4 rounded-xl border border-slate-200 bg-slate-50/50">
                            <input type="text" name="list_value[]" placeholder="99.8%" value="<?php echo htmlspecialchars($item['value'] ?? ''); ?>" class="w-24 rounded-lg border border-slate-200 px-3 py-2 text-sm">
                            <input type="text" name="list_title[]" placeholder="Title" value="<?php echo htmlspecialchars($item['title'] ?? ''); ?>" class="flex-1 min-w-[140px] rounded-lg border border-slate-200 px-3 py-2 text-sm">
