...
<body>
    ...
    <main class="overflow-hidden">
        ...
        <section class="min-h-screen flex flex-col lg:flex-row">
            <!-- Left: Text content -->
            <div class="flex-1 lg:flex-[0.48] bg-[#1a1a1a] flex flex-col justify-center px-4 md:px-12 lg:px-16 xl:px-20 py-10 lg:py-16">
                <h1 class="text-[#f2e780] font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[2.25rem] xl:text-5xl leading-tight tracking-tight mb-2" style="line-height: 1.5;" data-aos="fade-up">
                    <?= $homeData ? htmlspecialchars($homeData['title']) : 'PT. SAMSON KAPAL YUDHA SAMUDERA' ?>
                </h1>
                <p class="text-gray-300 text-sm md:text-base lg:text-xl max-w-2xl mb-6" style="line-height: 2.5;" data-aos="fade-up" data-aos-delay="100">
                    <?= $homeData ? htmlspecialchars($homeData['description']) : 'Manajemen Kapal Terintegrasi dengan AI dan Standar Internasional' ?>
                </p>
                <div class="flex items-center justify-center gap-2 bg-[#f2e780] rounded-full w-fit px-4" data-aos="fade-up" data-aos-delay="200">
                    <a href="<?= $homeData && !empty($homeData['button_link']) ? htmlspecialchars($homeData['button_link']) : '#' ?>" class="text-black text-md inline-flex items-center gap-2" style="line-height: 2.5;">
        ...
        <section class="flex flex-col lg:flex-row">
            ...
            <div class="flex-1 lg:flex-[0.52] relative aspect-[4/5] lg:aspect-[4/5] order-2 lg:order-1 w-full">
                <img
                    src="/assets/jhon-emanuel.jpeg"
                    alt="Direktur Utama PT. Samson Kapal Yudha Samudera"
            ...
            <!-- Right: Text content -->
            <div class="flex-1 lg:flex-[0.48] flex flex-col justify-center px-4 md:px-12 lg:px-16 xl:px-20 py-6 lg:py-16 order-1 lg:order-2">
                <span class="inline-block bg-[#423d09] w-fit text-gray-300 px-4 py-2 text-sm font-semibold rounded mb-6" data-aos="fade-up">
                    DIREKTUR UTAMA
                </span>

                <h2 class="text-[#f2e780] font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[2.25rem] xl:text-7xl leading-tight tracking-tight mb-2" style="line-height: 1.5;" data-aos="fade-up" data-aos-delay="100">
                    John Anderson
                </h2>

                <p class="text-gray-300 text-sm md:text-base lg:text-lg max-w-2xl leading-relaxed" style="line-height: 2;" data-aos="fade-up" data-aos-delay="200">
                    Memimpin PT. Samson Kapal Yudha Samudera dengan komitmen terhadap keselamatan, keandalan operasional, dan kemitraan jangka panjang dengan seluruh stakeholder.
                </p>
            </div>
        </section>
        ...
        <section id="moto" class="py-10 md:py-16 lg:py-20 px-4 md:px-10 lg:px-16 xl:px-24 relative">
            <div class="space-y-10">
                <!-- Motto -->
                <div class="space-y-10">
                    <span class="inline-block bg-[#423d09] text-gray-300 px-4 py-2 text-sm font-semibold rounded" data-aos="fade-up">
                        <?= $taglineData ? htmlspecialchars($taglineData['title_moto']) : 'MOTTO PERUSAHAAN' ?>
                    </span>

                    <h2 class="text-[#f2e780] text-xl md:text-2xl lg:text-[2.25rem] xl:text-7xl max-w-6xl font-medium leading-relaxed" style="line-height: 1.3;" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="space-y-6">
                    ...
                    <h2 class="text-[#f2e780] text-xl md:text-2xl leading-relaxed" style="line-height: 1.3;" data-aos="fade-up" data-aos-delay="100">
        ...
        <section class="flex flex-col lg:flex-row">
            ...
            <div class="flex-1 lg:flex-[0.6] flex flex-col justify-center px-4 md:px-12 lg:px-16 xl:px-20 py-10 lg:py-16 space-y-20">
                <h2 class="text-[#f2e780] text-xl md:text-2xl xl:text-5xl max-w-6xl font-medium leading-relaxed" style="line-height: 1.3;" data-aos="fade-up">
                    ...
                    <?php foreach ($missionList as $i => $item): ?>
                        <div class="relative border-t-4 border-[#f2e780] pt-6 pb-4 px-5">
                            <div class="absolute -top-[28px] left-1/2 -translate-x-1/2 flex justify-center">
                                <span class="w-14 h-14 rounded-full bg-[#f2e780] text-[#1a1a1a] font-bold flex items-center justify-center text-base shadow-md ring-2 ring-[#212121]"><?= (int)($item['number'] ?? 0) ?></span>
                            </div>

                            <h3 class="text-gray-300 font-semibold text-base md:text-lg mb-4" data-aos="fade-up" data-aos-delay="<?= $i * 80 ?>"><?= htmlspecialchars($item['title'] ?? '') ?></h3>
                            <p class="text-gray-400 text-sm md:text-base leading-relaxed" data-aos="fade-up" data-aos-delay="<?= $i * 80 + 50 ?>"><?= htmlspecialchars($item['description'] ?? '') ?></p>
                ...
                <?php foreach ($shipTypes as $i => $item): ?>
                    <div class="flex gap-4 items-start p-4 rounded-lg">
                        ...
                        <div class="min-w-0 flex-1">
                            <h3 class="text-gray-300 font-semibold text-base md:text-lg mb-2" data-aos="fade-up" data-aos-delay="<?= $i * 80 ?>"><?= htmlspecialchars($item['title']) ?></h3>
                            <p class="text-gray-400 text-sm md:text-base leading-relaxed" data-aos="fade-up" data-aos-delay="<?= $i * 80 + 40 ?>"><?= htmlspecialchars($item['description']) ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
        ...
        <section id="sistem-manajemen" class="relative flex flex-col lg:flex-row">
            <!-- Left: Text content -->
            <div class="flex-1 lg:flex-[0.55] flex flex-col justify-center pr-0 lg:pr-8 xl:pr-12 space-y-14 md:py-16 px-4 md:px-10 lg:px-16">
                <h2 class="text-[#f2e780] text-xl md:text-2xl xl:text-6xl max-w-3xl font-medium leading-relaxed" style="line-height: 1.3;" data-aos="fade-up">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                    <?php foreach ($systemMgmtSections as $i => $section): ?>
                        <div class="space-y-10">
                            <h3 class="text-[#f2e780] text-base md:text-xl" data-aos="fade-up" data-aos-delay="<?= $i * 100 ?>"><?= htmlspecialchars($section['title'] ?? '') ?></h3>
                            <?php if (!empty($section['description']) && trim((string)$section['description']) !== ''): ?>
                                <p class="text-gray-400 text-base leading-relaxed capitalize" style="max-width: 250px;" data-aos="fade-up" data-aos-delay="<?= $i * 100 + 50 ?>"><?= htmlspecialchars($section['description']) ?></p>
                            <?php endif; ?>
                            ...
                            if (!empty($sectionList)): ?>
                                <ul class="space-y-4 text-gray-400 text-base list-disc list-inside leading-relaxed">
                                    <?php foreach ($sectionList as $j => $item): ?>
                                        <li data-aos="fade-up" data-aos-delay="<?= $i * 100 + 100 + $j * 60 ?>"><?= htmlspecialchars($item['title'] ?? '') ?></li>
                                    <?php endforeach; ?>
                                </ul>
                            <?php endif; ?>
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-gray-400 text-base leading-relaxed capitalize" data-aos="fade-up" data-aos-delay="100">SKYS AI Brain untuk <span class="text-[#f2e780]">predictive maintenance, optimasi rute,</span> dan <span class="text-[#f2e780]">analitik in real-time</span>.</p>
                </div>
            </div>
                            ...
                            <div class="flex-shrink-0 flex flex-col items-center">
                                <div class="w-14 h-14 md:w-24 md:h-24 flex items-center justify-center transition-colors">
                                    <?php if (!empty($item['image'])): ?>
                                        <img src="<?= htmlspecialchars((strpos($item['image'], '/') === 0 ? '' : '/') . $item['image']) ?>" alt="" class="w-full h-full object-cover">
                                    <?php endif; ?>
                                </div>
                            </div>

                            <div class="flex-1 min-w-0 pb-10 md:pb-12">
                                <h3 class="text-gray-300 font-semibold text-base md:text-lg mb-2" data-aos="fade-up" data-aos-delay="<?= $i * 80 ?>">
                                    <?= htmlspecialchars($item['title'] ?? '') ?>
                                </h3>
                                <?php if (!empty($item['description'])): ?>
                                    <p class="text-gray-400 text-sm md:text-base leading-relaxed" data-aos="fade-up" data-aos-delay="<?= $i * 80 + 40 ?>">
        ...
        <section id="skys-ai-brain" class="py-10 md:py-16 px-4 md:px-10 lg:px-16">
            <div class="flex flex-col lg:flex-row gap-10 lg:gap-12">
                ...
                <div class="flex-1 min-w-0 lg:min-w-[55%] lg:max-w-[60%] space-y-20">
                    <h2 class="text-[#f2e780] text-xl md:text-2xl lg:text-3xl xl:text-5xl font-bold leading-tight" data-aos="fade-up">
                        <?= $skyAiBrainData ? htmlspecialchars($skyAiBrainData['title']) : 'Inovasi dengan SKYS AI Brain' ?>
                    </h2>

                    <div class="space-y-6">
                        <p class="text-gray-300 text-base md:text-lg leading-relaxed" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <?php foreach ($skyAiBrainFeatures as $j => $f): ?>
                                    <div class="p-4 md:p-5 rounded-lg bg-[#2a2a2a] border border-gray-600/50 space-y-6">
                                        <h3 class="text-gray-300 font-semibold text-sm md:text-2xl max-w-[200px] mb-2" data-aos="fade-up" data-aos-delay="<?= 200 + $j * 80 ?>"><?= htmlspecialchars($f['title'] ?? '') ?></h3>
                                        <p class="text-gray-400 text-xs md:text-base leading-relaxed" data-aos="fade-up" data-aos-delay="<?= 200 + $j * 80 + 40 ?>"><?= htmlspecialchars($f['description'] ?? '') ?></p>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        <?php endif; ?>
                ...
                <?php if ($skyAiBrainData && !empty($skyAiBrainData['image'])): ?>
                    <div class="flex-shrink-0 w-full lg:w-[45%] xl:w-[40%]">
                        <img
                            src="<?= htmlspecialchars((strpos($skyAiBrainData['image'], '/') === 0 ? '' : '/') . $skyAiBrainData['image']) ?>"
        ...
        <section id="komitmen-kinerja" class="py-10 md:py-16 px-4 md:px-10 lg:px-16">
            <div class="space-y-10">
                <h2 class="text-[#f2e780] text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-10 md:mb-12" data-aos="fade-up">
                                ...
                                <div class="kpi-card space-y-4">
                                    <div class="flex items-center gap-3">
                                        <div class="flex-1 h-2.5 md:h-3 bg-gray-600 rounded-full overflow-hidden">
                                            <div class="kpi-progress-bar h-full bg-[#f2e780] rounded-full transition-all duration-1000 ease-out" style="width: 0;" data-value="<?= (float) $percent ?>"></div>
                                        </div>
                                        <span class="text-gray-400 font-semibold text-sm md:text-base whitespace-nowrap"><?= htmlspecialchars($rawValue) ?></span>
                                    </div>

                                    <h3 class="text-gray-400 text-base md:text-lg" data-aos="fade-up"><?= htmlspecialchars($item['title'] ?? '') ?></h3>
                                    <p class="text-gray-400 text-sm md:text-base" data-aos="fade-up" data-aos-delay="50"><?= htmlspecialchars($item['description'] ?? '') ?></p>
                                </div>
                            <?php endforeach; ?>
                        </div>
                        <div class="space-y-6">
                ...
                <?php else: ?>
                    <p class="text-gray-400 text-sm md:text-base mt-8 md:mt-10 max-w-4xl" data-aos="fade-up">
                        Kami memantau 33 indikator KPI kunci, mengacu pada BIMCO Shipping KPI, untuk memastikan kinerja terbaik.
                    </p>
                <?php endif; ?>
            </div>
        </section>
        ...
        <section id="partnership" class="flex flex-col lg:flex-row">
            ...
            <?php if ($partnershipData && !empty($partnershipData['image'])): ?>
                <div class="w-full lg:w-[30%] lg:flex-shrink-0 relative min-h-[280px] lg:min-h-[300px]">
                    <img
                        src="<?= htmlspecialchars((strpos($partnershipData['image'], '/') === 0 ? '' : '/') . $partnershipData['image']) ?>"
            ...
            <div class="flex-1 flex flex-col justify-center px-4 md:px-10 lg:px-12 xl:px-20 py-12 lg:py-16 space-y-14">
                ...
                <?php if ($partnershipData && !empty(trim($partnershipData['quete'] ?? ''))): ?>
                    <div class="flex gap-4">
                        ...
                        <p class="text-gray-300 text-base md:text-lg leading-relaxed flex-1" style="line-height: 2;" data-aos="fade-up" data-aos-delay="100">
        ...
        <section id="hubungi-kami" class="flex flex-col lg:flex-row">
            ...
            <div class="flex-1 lg:flex-[0.65] flex flex-col justify-center px-4 md:px-12 lg:px-16 xl:px-20 py-10 lg:py-20 space-y-10">
                        ...
                        <div class="space-y-10">
                            ...
                            <div class="text-white text-sm md:text-base space-y-4">
                                <?php if (!empty($contactData['building_name'])): ?>
                                    <p class="text-lg" data-aos="fade-up" data-aos-delay="150"><?= htmlspecialchars($contactData['building_name']) ?><?= !empty($contactData['floor']) ? ', ' . htmlspecialchars($contactData['floor']) : '' ?></p>
                                <?php endif; ?>
                                <?php if (!empty($contactData['district'])): ?>
                                    <p class="text-lg" data-aos="fade-up" data-aos-delay="200"><?= htmlspecialchars($contactData['district']) ?></p>
                                <?php endif; ?>
                                <?php if (!empty($contactData['street_address'])): ?>
                                    <p class="text-lg" data-aos="fade-up" data-aos-delay="250"><?= htmlspecialchars($contactData['street_address']) ?></p>
                                <?php endif; ?>
                                <?php if (!empty($contactData['city'])): ?>
                                    <p class="text-lg" data-aos="fade-up" data-aos-delay="300"><?= htmlspecialchars($contactData['city']) ?><?= !empty($contactData['postal_code']) ? ', ' . htmlspecialchars($contactData['postal_code']) : '' ?></p>
                                <?php endif; ?>
                                <?php if (!empty($contactData['country'])): ?>
                                    <p class="text-lg" data-aos="fade-up" data-aos-delay="350"><?= htmlspecialchars($contactData['country']) ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="space-y-10">
                            ...
                            <ul class="text-white text-sm md:text-base space-y-4">
                                <?php if (!empty($contactData['phone'])): ?>
                                    <li class="text-lg" data-aos="fade-up" data-aos-delay="150">Telepon: <a href="tel:<?= htmlspecialchars(preg_replace('/\s+/', '', $contactData['phone'])) ?>" class="hover:text-[#f2e780] transition-colors text-lg"><?= htmlspecialchars($contactData['phone']) ?></a></li>
                                <?php endif; ?>
                                <?php if (!empty($contactData['email'])): ?>
                                    <li class="text-lg" data-aos="fade-up" data-aos-delay="200">Email: <a href="mailto:<?= htmlspecialchars($contactData['email']) ?>" class="hover:text-[#f2e780] transition-colors text-lg"><?= htmlspecialchars($contactData['email']) ?></a></li>
                                <?php endif; ?>
                                <?php if (!empty($contactData['website'])): ?>
                                    <li class="text-lg" data-aos="fade-up" data-aos-delay="250">Website: <a href="<?= htmlspecialchars(strpos($contactData['website'], 'http') === 0 ? $contactData['website'] : 'https://' . $contactData['website']) ?>" target="_blank" rel="noopener noreferrer" class="hover:text-[#f2e780] transition-colors"><?= htmlspecialchars($contactData['website']) ?></a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="flex-1 lg:flex-[0.35] relative min-h-[280px] lg:min-h-0">
                <?php if ($contactData && !empty($contactData['image_url'])): ?>
                    <img
                        src="<?= htmlspecialchars((strpos($contactData['image_url'], '/') === 0 ? '' : '/') . $contactData['image_url']) ?>"
