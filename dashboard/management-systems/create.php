    ...
    <main class="flex-1 min-w-0 h-screen overflow-y-auto px-4 md:px-8 space-y-4 pb-4">
        ...
        <div class="px-4 md:px-8 py-4">
            <div class="flex items-center justify-between">
                ...
                <a href="/dashboard/management-systems"
                    ...
                    <span class="hidden sm:inline">Back to Management Systems</span>
        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <form action="/dashboard/management-systems/process.php" method="POST" class="space-y-6" id="mgmtForm">
                <script>
                ...
                <div class="flex items-center gap-4 pt-4 border-t border-slate-100">
                    <button type="submit" form="mgmtForm" onclick="return validateForm()"
