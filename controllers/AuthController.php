...
class AuthController
{
    ...
    public function register(): void
    {
        ...
        try {
            ...
            $stmt = $this->db->prepare("INSERT INTO `accounts` (fullname, email, password, role_id) VALUES (?, ?, ?, 1)");
    ...
    public function login(): void
    {
        ...
        try {
            ...
            $stmt = $this->db->prepare(
                "SELECT a.id, a.fullname, a.email, a.password, r.name AS role " .
                    "FROM `accounts` a LEFT JOIN `roles` r ON a.role_id = r.id " .
                    "WHERE a.email = ? OR a.fullname = ? LIMIT 1"
            );
